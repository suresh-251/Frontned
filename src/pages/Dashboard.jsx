  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          title="Active Page"
          value={stats.pageName || "N/A"}
          subtitle="Currently connected Facebook page"
          color="blue"
          icon={
        ...
        <StatCard
          ...
          trend="12.5%"
          trendDirection="up"
          subtitle="All-time leads collected"
          color="green"
          icon={
        ...
        <StatCard
          ...
          trend="8.2%"
          trendDirection="up"
          subtitle="Leads collected this month"
          color="purple"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <StatCard
          title="Enabled Forms"
          value={stats.enabledForms}
          subtitle="Active lead generation forms"
          color="orange"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Card className="p-6" hover>
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">View and export leads</p>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
            </svg>
