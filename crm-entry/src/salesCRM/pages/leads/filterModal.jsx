          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            {dateField && dateMode === "date" ? (
              <div style={{ position: "relative" }}>
                <button type="button" onClick={() => setActiveDatePicker((current) => current === "single" ? null : "single")} style={{ width: "100%", padding: "10px 12px", border: "1.5px solid #e5e7eb", borderRadius: 10, background: "#fff", fontSize: 13, fontWeight: 600, color: "#374151", textAlign: "left", cursor: "pointer" }}>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                {[["from", `${datePrefixLabel} From`, fromKey], ["to", `${datePrefixLabel} To`, toKey]].map(([pickerKey, label, key]) => (
                  <div key={pickerKey} style={{ position: "relative" }}>
                    <button type="button" onClick={() => setActiveDatePicker((current) => current === pickerKey ? null : pickerKey)} style={{ width: "100%", padding: "10px 12px", border: "1.5px solid #e5e7eb", borderRadius: 10, background: "#fff", fontSize: 13, fontWeight: 600, color: "#374151", textAlign: "left", cursor: "pointer" }}>
