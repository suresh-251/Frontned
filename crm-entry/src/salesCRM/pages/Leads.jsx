  ...
  return (
    <div className="table-card-shell sales-leads-history-shell" style={{ marginTop: 18, marginInline: "auto", width: "fit-content", maxWidth: "100%" }}>
      <div className="table-card sales-leads-history-card" style={{ width: "fit-content", maxWidth: "100%" }}>
        <button onClick={() => setOpen((current) => !current)} style={{ width: "fit-content", maxWidth: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, padding: "16px 18px", border: "none", background: "transparent", cursor: "pointer" }}>
