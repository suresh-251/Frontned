                    ...
                    <div className="flex justify-end gap-1">
                      ...
                      {isManager && (
                        <>
                          ...
                          <button onClick={() => setConfirm({ show: true, title: "Purge", message: "Delete record?", onConfirm: () => handleDelete(item.id) })} className="p-1.5 bg-[var(--bg-body)] border border-[var(--border-color)] rounded text-slate-300 hover:text-rose-500 transition-all"><Trash2 size={13}/></button>
                        </>
                      )}
                    </div>
                  </td>
