...
//   return (
//     <div className="h-[calc(100vh-100px)] w-full flex flex-col gap-3 overflow-hidden text-slate-900 p-1">
...
//           <div className="flex-1 bg-white border border-slate-200 rounded-xl p-3 shadow-sm flex flex-col relative">
...
//                   <XAxis dataKey="day" axisLine={false} tickLine={false} tick={{fontSize: 9, fontWeight: 'bold', fill: '#94a3b8'}} dy={5} />
//                   {/* domain={[0, 700]} keeps the line in the middle-bottom */}
...
//           <div className="h-40 bg-white border border-slate-200 rounded-xl p-3 shadow-sm shrink-0">
...
//                 <div key={todo.taskId} className="flex items-center gap-2 p-1.5 bg-slate-50 rounded-lg border border-slate-100 group hover:border-indigo-200 transition-colors">
...
//                 </div>
//              )) : <p className="text-[10px] text-slate-300 font-bold italic">No pending tasks</p>}
...
//              </div>
//           </div>
//           <button className="w-full mt-3 py-2 bg-slate-900 text-white rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all shrink-0 active:scale-95">
//             Full Reports
//           </button>
//         </div>
...
//   <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded-lg border border-slate-100 hover:bg-white transition-colors">
...
//   };
//   return (
//     <div className="bg-white p-2 rounded-lg border border-slate-200 shadow-sm flex items-center gap-2 hover:border-indigo-200 transition-all cursor-default group">
